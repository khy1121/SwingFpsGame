...
public class CharacterData {
    ...
    public static Ability[] createAbilities(String characterId) {
        switch (characterId.toLowerCase()) {
            case "raven":
                return new Ability[] {
                        new Ability("raven_basic", "고속 연사", "빠른 연사 권총 공격", Ability.AbilityType.BASIC, 0.3f, 0f, 500f,
                                15f),
                        new Ability("raven_dash", "대쉬", "빠르게 전방으로 돌진", Ability.AbilityType.TACTICAL, 5f, 0.5f, 200f,
                                0f),
                        new Ability("raven_overcharge", "과충전", "공격 속도 대폭 증가", Ability.AbilityType.ULTIMATE, 20f, 6f, 0f,
                                0f)
                };
            ...
            case "technician":
                return new Ability[] {
                        ...
                        new Ability("tech_turret", "터렛", "자동 사격 터렛 배치", Ability.AbilityType.ULTIMATE, 40f, 20f, 150f,
                                25f)
                };
            ...
            case "ghost":
                return new Ability[] {
                        new Ability("ghost_basic", "소음기 SMG", "조용한 기관단총", Ability.AbilityType.BASIC, 0.2f, 0f, 300f,
                                18f),
                        new Ability("ghost_cloak", "투명화", "일시적 투명 상태", Ability.AbilityType.TACTICAL, 15f, 6f, 0f, 0f),
                        new Ability("ghost_nullify", "열감지 무효", "감지 불가 상태", Ability.AbilityType.ULTIMATE, 30f, 10f, 0f,
                                0f)
                };
            ...
            case "skull":
                return new Ability[] {
                        ...
                        new Ability("skull_adrenaline", "아드레날린", "체력 회복", Ability.AbilityType.TACTICAL, 15f, 0f, 0f,
                                -50f),
                        new Ability("skull_ammo", "탄약 보급", "모든 스킬 쿨타임 초기화", Ability.AbilityType.ULTIMATE, 40f, 0f, 0f,
                                0f)
                };
            ...
            case "sage":
                return new Ability[] {
                        ...
                        new Ability("sage_heal", "치료", "아군 또는 자신 회복", Ability.AbilityType.TACTICAL, 15f, 0f, 200f,
                                -60f),
                        new Ability("sage_revive", "부활", "쓰러진 아군 부활", Ability.AbilityType.ULTIMATE, 90f, 3f, 300f,
                                -100f)
                };

            case "bulldog":
                return new Ability[] {
                        new Ability("bull_basic", "미니건", "고속 연사 미니건", Ability.AbilityType.BASIC, 0.1f, 0f, 400f, 8f),
                        new Ability("bull_cover", "엄폐", "방어력 대폭 증가", Ability.AbilityType.TACTICAL, 12f, 4f, 0f, 0f),
                        new Ability("bull_barrage", "폭발탄", "주변 광역 폭발", Ability.AbilityType.ULTIMATE, 35f, 0f, 0f, 0f)
                };

            case "wildcat":
                return new Ability[] {
                        new Ability("wild_basic", "산탄총", "근거리 강력한 산탄", Ability.AbilityType.BASIC, 0.8f, 0f, 250f, 15f), // 펠릿
                                                                                                                        // 구현은
                                                                                                                        // 별도
                                                                                                                        // 필요하지만
                                                                                                                        // 일단
                                                                                                                        ...
                                                                                                                        // 강한
                                                                                                                        // 데미지로
                        new Ability("wild_breach", "돌파", "전방으로 빠르게 돌진하며 밀치기", Ability.AbilityType.TACTICAL, 8f, 0.5f,
                                0f, 0f),
                        new Ability("wild_berserk", "광폭화", "이동속도 및 공격력 증가", Ability.AbilityType.ULTIMATE, 25f, 6f, 0f,
                                0f)
                };

            case "steam":
                return new Ability[] {
                        new Ability("steam_basic", "돌격소총", "밸런스형 소총", Ability.AbilityType.BASIC, 0.15f, 0f, 550f, 12f),
                        new Ability("steam_emp", "EMP", "주변 적 스킬 차단", Ability.AbilityType.TACTICAL, 18f, 0f, 300f, 0f),
                        new Ability("steam_reset", "전술 리셋", "자신과 주변 아군 쿨타임 감소", Ability.AbilityType.ULTIMATE, 45f, 0f,
                                400f, 0f)
                };
            ...
            default:
                ...
                return new Ability[] {
                        ...
                        new Ability("default_tactical", "전술 스킬", "전술 스킬", Ability.AbilityType.TACTICAL, 10f, 0f, 300f,
                                0f),
